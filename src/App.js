...
//import Address from './pages/manufacturer/address.js';
...
import SellToCustomer from './pages/sellToCustomer.js';
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/m_login" element={<MLogin setAddress={setAddress} setBrandName={setBrandName}/>} />
          <Route path="/manufacturer" element={<Manuf />} />
          <Route path="/manufacturer/addProduct" element={<AddProduct address={address} />} />
          <Route path="/login" element={<Qrcode />} />
          ...
          <Route path="/seller/selltoConsumer" element={<SellToCustomer address={address}/>}/>
        </Routes>
      </div>
    </Router>
  );
